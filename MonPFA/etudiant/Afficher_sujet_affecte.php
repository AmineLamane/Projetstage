...
if(empty($_SESSION['etudiant'])){
    ...
    $bdd = fct_bdd();
    //$stmt = $bdd->prepare("SELECT sujet.intitule_sujet ,sujet.description_sujet , professeur.nom ,professeur.prenom,professeur.email,binome.cin_enc FROM sujet ,professeur,binome where sujet.cin = professeur.cin AND sujet.cin = binome.cin_enc ");
    $stmt = $bdd->prepare("SELECT s.intitule_sujet ,s.description_sujet , p.nom ,p.prenom,p.email FROM sujet s ,professeur p,binome b where s.cin = p.cin AND s.cin = b.cin_enc ");
    $stmt->execute();
    $row=$stmt->fetch();
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="indexe">
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <h2 style="margin-left: 40%"> <kbd>MON SUJET</kbd></h2>
                                                    ...
                                                    <form action="" method="post">
                                                        <div class="table-responsive ">
                                                            <table class="table table-hover table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Intitule sujet </th>
                                                                        <td><?php echo $row['intitule_sujet']; ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Description</th>
                                                                        <td><?php echo $row['description_sujet']; ?>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Nom d'encadrant</th>
                                                                        <td><?php echo $row['nom'].' '.$row['prenom']; ?>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Son adresse email</th>
