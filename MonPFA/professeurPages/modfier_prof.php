...
if(isset($_POST['ancienne_mdp']) and isset($_POST['nouveau_mdp']) and isset($_POST['conf_nouveau_mdp'])){
    ...
    if($_POST['ancienne_mdp'] == $_SESSION['professeur']->mdp){
        $stmt = $bdd->prepare("UPDATE professeur set mdp = ? ,email = ?,nom = ?, prenom = ? where cin=? ");
        $stmt->execute([$_POST['nouveau_mdp'],$_POST['nouv_email'],$_POST['nouv_nom'],$_POST['nouv_prenom'],$prof->cin]);
        $_SESSION['professeur']->mdp = $_POST['nouveau_mdp'];
        $_SESSION['professeur']->email = $_POST['nouv_email'];
        $_SESSION['professeur']->nom = $_POST['nouv_nom'];
        $_SESSION['professeur']->prenom = $_POST['nouv_prenom'];
