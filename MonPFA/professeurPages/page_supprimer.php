...
if (isset ($_POST['valider']))
{
    ...
    echo  "<script>alert('impossible de supprimer ce sujet , il est deja classer')</script>";
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade in active" id="indexe">
                                                ...
                                                <h1 style="margin-left: 28%">SUPPRIMER UN PROJET</h1>
...
<input class="btn btn-success" type="submit" name="valider" value="OK"/></form>
                                            ...
                                            <div class="tab-pane fade" id="nonIndexe">
                                                ...
                                                <div class="panel panel-primary">
                                                <h1 style="margin-left: 33%">SUPPRIMER UN PROJET</h1>
                                                    <div class="panel-heading">
