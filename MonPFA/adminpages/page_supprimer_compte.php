                            ...
                            <div class="card">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="tab-content">
                                        <div id="login">
                                            <h1 style="margin-left: 27%">SUPPRIMER UN COMPTE </h1>

                                            <div class="container2">
                                                <img src="img/etud.png" alt="Avatar2" class="image2" style="width:200px">
                                            ...
                                            <div class="container2" >
                                                <img  src="img/prof.png" alt="Avatar2" class="image2" style="width:200px">
                                                <div class="overlay2" action="supprimer_prof.php">
                                                    <div class="text2">
                                                        <form method="post" action="supprimer_prof.php">
