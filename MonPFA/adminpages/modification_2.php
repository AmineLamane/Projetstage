...
if(isset($_POST['cocher'])){
    $stmt1 = $bdd->prepare("update professeur set nom = ? , prenom=?, email=? where cin =? ");
    $stmt1->execute([$_POST['nom'],$_POST['prenom'],$_POST['email'],$_POST['cin']]);
    
    
    echo "<script>alert('Le changemement est reussit');</script>";
    
    header("location:http://localhost/MonPFA/adminpages/modifier_prof.php");
                            ...
                            <div class="card">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="tab-content">
                                        <div id="login">
                                            <h1 style="margin-left: 30%">MODIFIER COMPTE ENCADRANT</h1>
                                            <form method="post" action="">
                                                <div class="form-group">cne <input class="form-control" type="text"
                                                        name="cin" value="<?php echo $row['cin'];?>" /></div>
