...
if (isset ($_POST['valider']))
{
    ...
    /*echo  "<script>alert('impossible de supprimer ce sujet , il est deja classe')</script>";*/
...
<head>
    ...
    <title>supprresion d'un etudiant</title>
                                        ...
                                        <div class="tab-pane fade in active" id="indexe">
                                            ...
                                            <div class="panel panel-success">
                                                <div class="panel-heading">
                                                    <i class="pe-7s-next-2" style="margin-left: 40%"></i> LES ETUDIANTS
                                                </div>
                                                <div class="panel-body">
...
?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="radio" name="cne"
                                                                                value="<?php echo $row['cne'];?>"></td>
