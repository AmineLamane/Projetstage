...
$query = "SELECT binome.cne1,binome.cne2,sujet.intitule_sujet,professeur.nom,professeur.prenom from binome,sujet,professeur where binome.id_sujet=sujet.id_sujet and professeur.cin = sujet.cin;";
  try {
                                        ...
                                        <div class="tab-pane fade in active" id="indexe">
                                            ...
                                            <div class="panel panel-success">
                                                <div class="panel-heading">
                                                    <i class="pe-7s-next-2" style="margin-left: 30%"></i> AFFECTATION DES SUJETS APRES TIRAGE AU SORT
                                                </div>
                                                <div class="panel-body">
...
?>
                ...
                $cne1 = $row['cne1'];
                $cne2 = $row['cne2'];
                $query1 = "SELECT nom,prenom FROM etudiant WHERE cne = '".$cne1."' ";
                $result1 = mysqli_query($conn, $query1);
                $r1 = mysqli_fetch_assoc($result1);
                $query2 = "SELECT nom,prenom FROM etudiant WHERE cne = '".$cne2."' ";
                $result2 = mysqli_query($conn, $query2);
                $r2 = mysqli_fetch_assoc($result2);
                
             ?>
                                                                        <td><?php echo $r1['nom'].' '.$r1['prenom']; ?>
                                                                        </td>
                                                                        <td><?php echo $r2['nom'].' '.$r2['prenom']; ?>
                                                                        </td>
